...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		try {
			...
			// AppID is ClayMonsters (5143390). Keep steam_appid.txt in the project root for Editor/dev launches.
			// Remove steam_appid.txt from shipped game depots.
			// See the Valve documentation for more information: https://partner.steamgames.com/doc/sdk/api#initialization_and_shutdown
			if (SteamAPI.RestartAppIfNecessary(new AppId_t(SteamAppIds.ClayMonsters))) {
