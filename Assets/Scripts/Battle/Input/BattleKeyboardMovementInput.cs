...

{
...

    {
...

        {
            ...
            stepApproachAction = CreateShiftModifiedAction("StepApproach", "<Keyboard>/d", "<Keyboard>/rightArrow");

            stepRetreatAction = CreateShiftModifiedAction("StepRetreat", "<Keyboard>/a", "<Keyboard>/leftArrow");
...

        {
...

            {
                ...
                bool approach = approachAction.IsPressed();

                bool retreat = retreatAction.IsPressed();
