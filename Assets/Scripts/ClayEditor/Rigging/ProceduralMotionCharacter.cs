...
namespace ClayEditor.Rigging
{
    ...
    public class ProceduralMotionCharacter : MonoBehaviour
    {
        ...
        private struct BoneInfo
        {
            ...
            public bool isLimbSwingRoot; // 歩行で振る付属肢の先頭
            public bool isLegSwingRoot; // 脚走行で振る脚の先頭
            public bool isArmSwingRoot; // 脚走行で振る腕の先頭
            public bool isOtherLimbSwingRoot; // 脚腕以外の付属肢先頭
        }
